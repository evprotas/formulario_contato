...
import formulario.contato.model.impl.MunicipioImpl;
import formulario.contato.model.impl.MunicipioModelImpl;
 ...
 * @generated
 */
@Component(service = MunicipioPersistence.class)
public class MunicipioPersistenceImpl
	extends BasePersistenceImpl<Municipio> implements MunicipioPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>MunicipioUtil</code> to access the municipio persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		MunicipioImpl.class.getName();
	 ...
	 */
	@Override
	public List<Municipio> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Municipio> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<Municipio> findByUuid(
	...
	public List<Municipio> findByUuid(
		...
		if (useFinderCache) {
			list = (List<Municipio>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (Municipio municipio : list) {
					if (!uuid.equals(municipio.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			try {
				...
				list = (List<Municipio>)QueryUtil.list(
	...
	public Municipio findByUuid_First(
		...
		Municipio municipio = fetchByUuid_First(uuid, orderByComparator);
	...
	public Municipio fetchByUuid_First(
		...
		List<Municipio> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Municipio findByUuid_Last(
		...
		Municipio municipio = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Municipio fetchByUuid_Last(
		...
		List<Municipio> list = findByUuid(
	...
	public Municipio[] findByUuid_PrevAndNext(
		...
		Municipio municipio = findByPrimaryKey(municipioId);
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, municipio, uuid, orderByComparator, true);

			array[1] = municipio;

			array[2] = getByUuid_PrevAndNext(
				session, municipio, uuid, orderByComparator, false);
	...
	protected Municipio getByUuid_PrevAndNext(
		Session session, Municipio municipio, String uuid,
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(municipio)) {
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(municipio.uuid IS NULL OR municipio.uuid = '')";
	...
	public Municipio findByUUID_G(String uuid, long groupId)
		...
		Municipio municipio = fetchByUUID_G(uuid, groupId);
	...
	public Municipio fetchByUUID_G(
		...
		if (result instanceof Municipio) {
			Municipio municipio = (Municipio)result;

			if (!Objects.equals(uuid, municipio.getUuid()) ||
				(groupId != municipio.getGroupId())) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					Municipio municipio = list.get(0);
	...
	public Municipio removeByUUID_G(String uuid, long groupId)
		...
		Municipio municipio = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(municipio.uuid IS NULL OR municipio.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Municipio> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Municipio> findByUuid_C(
	...
	public List<Municipio> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Municipio municipio : list) {
					if (!uuid.equals(municipio.getUuid()) ||
						(companyId != municipio.getCompanyId())) {
	...
	public Municipio findByUuid_C_First(
		...
		Municipio municipio = fetchByUuid_C_First(
	...
	public Municipio fetchByUuid_C_First(
		...
		List<Municipio> list = findByUuid_C(
	...
	public Municipio findByUuid_C_Last(
		...
		Municipio municipio = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Municipio[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, municipio, uuid, companyId, orderByComparator, true);

			array[1] = municipio;

			array[2] = getByUuid_C_PrevAndNext(
				session, municipio, uuid, companyId, orderByComparator, false);
	...
	protected Municipio getByUuid_C_PrevAndNext(
		Session session, Municipio municipio, String uuid, long companyId,
		OrderByComparator<Municipio> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Municipio> findByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<Municipio> findByGroupId(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public List<Municipio> findByGroupId(
	...
	public List<Municipio> findByGroupId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Municipio municipio : list) {
					if (groupId != municipio.getGroupId()) {
						list = null;
	...
	public Municipio findByGroupId_First(
		...
		Municipio municipio = fetchByGroupId_First(groupId, orderByComparator);
	...
	public Municipio fetchByGroupId_First(
		...
		List<Municipio> list = findByGroupId(groupId, 0, 1, orderByComparator);
	...
	public Municipio findByGroupId_Last(
		...
		Municipio municipio = fetchByGroupId_Last(groupId, orderByComparator);
	...
	public Municipio fetchByGroupId_Last(
		...
		List<Municipio> list = findByGroupId(
	...
	public Municipio[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, municipio, groupId, orderByComparator, true);

			array[1] = municipio;

			array[2] = getByGroupId_PrevAndNext(
				session, municipio, groupId, orderByComparator, false);
	...
	protected Municipio getByGroupId_PrevAndNext(
		Session session, Municipio municipio, long groupId,
		OrderByComparator<Municipio> orderByComparator, boolean previous) {
	...
	public MunicipioPersistenceImpl() {
		...
		setModelImplClass(MunicipioImpl.class);
	...
	public void cacheResult(Municipio municipio) {
		entityCache.putResult(
			entityCacheEnabled, MunicipioImpl.class, municipio.getPrimaryKey(),
			municipio);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {municipio.getUuid(), municipio.getGroupId()},
			municipio);
	...
	public void cacheResult(List<Municipio> municipios) {
		for (Municipio municipio : municipios) {
			if (entityCache.getResult(
					entityCacheEnabled, MunicipioImpl.class,
					municipio.getPrimaryKey()) == null) {
	...
	public void clearCache(Municipio municipio) {
		...
		clearUniqueFindersCache((MunicipioModelImpl)municipio, true);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, MunicipioImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		MunicipioModelImpl municipioModelImpl) {

		Object[] args = new Object[] {
			municipioModelImpl.getUuid(), municipioModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathCountByUUID_G, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, municipioModelImpl, false);
	}

	protected void clearUniqueFindersCache(
		MunicipioModelImpl municipioModelImpl, boolean clearCurrent) {
		...
		if ((municipioModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				municipioModelImpl.getOriginalUuid(),
				municipioModelImpl.getOriginalGroupId()
			};
	...
	public Municipio create(long municipioId) {
		...
		municipio.setPrimaryKey(municipioId);

		String uuid = PortalUUIDUtil.generate();

		municipio.setUuid(uuid);

		municipio.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public Municipio remove(long municipioId) throws NoSuchMunicipioException {
		return remove((Serializable)municipioId);
	}
	...
	public Municipio remove(Serializable primaryKey)
		...
		try {
			...
			Municipio municipio = (Municipio)session.get(
			...
			if (municipio == null) {
				...
				throw new NoSuchMunicipioException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(municipio);
		}
		catch (NoSuchMunicipioException noSuchEntityException) {
	...
	protected Municipio removeImpl(Municipio municipio) {
		...
		try {
			...
			if (!session.contains(municipio)) {
				municipio = (Municipio)session.get(
					MunicipioImpl.class, municipio.getPrimaryKeyObj());
			}
	...
	public Municipio updateImpl(Municipio municipio) {
		...
		if (!(municipio instanceof MunicipioModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(municipio.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(municipio);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in municipio proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Municipio implementation " +
					municipio.getClass());
		}

		MunicipioModelImpl municipioModelImpl = (MunicipioModelImpl)municipio;

		if (Validator.isNull(municipio.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (municipio.getCreateDate() == null)) {
			if (serviceContext == null) {
				municipio.setCreateDate(now);
			}
			else {
				municipio.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!municipioModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				municipio.setModifiedDate(now);
			}
			else {
				municipio.setModifiedDate(serviceContext.getModifiedDate(now));
			}
		}
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {municipioModelImpl.getUuid()};
			...
			args = new Object[] {
				municipioModelImpl.getUuid(), municipioModelImpl.getCompanyId()
			};
			...
			args = new Object[] {municipioModelImpl.getGroupId()};
			...
			if ((municipioModelImpl.getColumnBitmask() &
				...
				args = new Object[] {municipioModelImpl.getUuid()};
			...
			if ((municipioModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					municipioModelImpl.getOriginalUuid(),
					municipioModelImpl.getOriginalCompanyId()
				};
				...
				args = new Object[] {
					municipioModelImpl.getUuid(),
					municipioModelImpl.getCompanyId()
				};
		...
		clearUniqueFindersCache(municipioModelImpl, false);
		cacheUniqueFindersCache(municipioModelImpl);
	...
	/**
	 * Returns the municipio with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the municipio
	...
	public Municipio findByPrimaryKey(long municipioId)
		...
		return findByPrimaryKey((Serializable)municipioId);
	}
	...
	public Municipio fetchByPrimaryKey(long municipioId) {
		return fetchByPrimaryKey((Serializable)municipioId);
	}
	...
	public void activate() {
		MunicipioModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		MunicipioModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, MunicipioImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			MunicipioModelImpl.UUID_COLUMN_BITMASK |
			MunicipioModelImpl.NOME_COLUMN_BITMASK);
		...
		_finderPathFetchByUUID_G = new FinderPath(
			...
			MunicipioModelImpl.UUID_COLUMN_BITMASK |
			MunicipioModelImpl.GROUPID_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			new String[] {String.class.getName(), Long.class.getName()},
			MunicipioModelImpl.UUID_COLUMN_BITMASK |
			MunicipioModelImpl.COMPANYID_COLUMN_BITMASK |
			MunicipioModelImpl.NOME_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.formulario.contato.model.Municipio"),
			true);
	}
	...
	private static final String _SQL_SELECT_MUNICIPIO =
		"SELECT municipio FROM Municipio municipio";

	private static final String _SQL_SELECT_MUNICIPIO_WHERE =
		"SELECT municipio FROM Municipio municipio WHERE ";

	private static final String _SQL_COUNT_MUNICIPIO =
		"SELECT COUNT(municipio) FROM Municipio municipio";

	private static final String _SQL_COUNT_MUNICIPIO_WHERE =
		"SELECT COUNT(municipio) FROM Municipio municipio WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "municipio.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No Municipio exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No Municipio exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		MunicipioPersistenceImpl.class);
