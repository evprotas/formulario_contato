...
package formulario.contato.service.persistence.impl.constants;
...
public class FCPersistenceConstants {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(FCPersistenceConstants.class);
