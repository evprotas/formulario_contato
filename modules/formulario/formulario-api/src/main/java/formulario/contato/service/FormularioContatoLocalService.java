...
/**
 * Provides the local service interface for FormularioContato. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Eglen
 * @see FormularioContatoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FormularioContatoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FormularioContatoLocalServiceUtil} to access the formulario contato local service. Add custom service methods to <code>formulario.contato.service.impl.FormularioContatoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
